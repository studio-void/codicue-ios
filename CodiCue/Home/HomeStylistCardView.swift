...
struct HomeStylistCardView: View {
    @State var imageURL: URL? = URL(string: "https://i.namu.wiki/i/plYksH3UeGGZLVgjTfbJ8rf1vN2HMIl9ztcpxtfpeQwCYR1CBh3SzbQ0RsgbZ65xiYR-fk7A3Dxy7cExs4rABQ.webp")
...
#Preview {
    HomeStylistCardView(name: "장원영", rating: 4.93, descriptions: ["서울 플라시 어워드 금상", "포브스 선정 올해의 스타일리스트", "(현) 연예인 스타일리스트"])
}
